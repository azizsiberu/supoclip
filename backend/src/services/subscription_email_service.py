...
class SubscriptionEmailService:
    ...
    def _build_subscribed_email(self, user: User) -> EmailContent:
        ...
        return EmailContent(
            subject="Thanks for subscribing to KlipOS",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Thanks for subscribing to KlipOS.</p>"
            ...
            text=(
                f"Hi {first_name},\n\n"
                "Thanks for subscribing to KlipOS.\n\n"
    ...
    def _build_unsubscribed_email(self, user: User) -> EmailContent:
        first_name = self._first_name_for(user)
        return EmailContent(
            subject="Sorry to see you go from KlipOS",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Sorry to see you go, and thanks for trying KlipOS.</p>"
                "<p>Your subscription has been canceled. If you ever want to come back, we’d love to have you.</p>"
                "<p>Team KlipOS</p>"
            ),
            text=(
                f"Hi {first_name},\n\n"
                "Sorry to see you go, and thanks for trying KlipOS.\n\n"
